...
function Caret(props) {
  ...
  var style = (0, _objectSpread3["default"])({
    pointerEvents: 'none',
    position: 'absolute'
  }, getPosition(edge, align, size), (_objectSpread2 = {}, (0, _defineProperty2["default"])(_objectSpread2, "margin".concat(perp), align ? null : -size), (0, _defineProperty2["default"])(_objectSpread2, "marginTop", '-1px'), _objectSpread2)); // note: these arrays represent points in the form [x, y]
